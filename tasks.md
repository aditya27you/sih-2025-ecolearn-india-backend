...
- [x] T006 Create `src/routes/index.ts` (or `server.ts` in routes) as main router entry point
...
- [x] T015 [US1] Register Auth and User routes in `src/app.ts` (or main router)
