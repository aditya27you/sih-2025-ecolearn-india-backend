...
export const getGlobalLeaderboard = catchAsync(
...
export const getSchoolLeaderboard = catchAsync(
  async (req: Request, res: Response) => {
...
export const getGradeLeaderboard = catchAsync(
  async (req: Request, res: Response) => {
    const grade = parseInt(req.params.grade);
    const limit = req.query.limit ? parseInt(req.query.limit as string) : 10;
    const leaderboard = await leaderboardService.getGradeLeaderboard(
      grade,
      limit,
    );
    res
